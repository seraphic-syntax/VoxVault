...
class RecordingDetailViewController: UITableViewController {
    ...
    private enum Section: Int, CaseIterable {
        case info, customization, transcription, actions
        var title: String? {
            switch self {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .info:
            ...
            case 0: cell.configure(title: "Date", value: df.string(from: session.date))
            ...
            case 3: cell.configure(title: "Size", value: ByteCountFormatter.string(fromByteCount: session.totalSize, countStyle: .file))
            default: break
            }
            return cell
        case .customization:
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .transcription:
            if metadata.transcription == nil { generateTranscription() }
            else { if indexPath.row == 0 { showTranscription() } else { deleteTranscription() } }
        case .actions:
            switch indexPath.row {
